(() => {
  ...
  const TRANSLATIONS = {
    en: {
      ...
      countdownNote: 'Das & Haldar family cordially invite you',
      ...
      haldiTag: 'A Splash of Yellow', haldiName: 'Haldi Ceremony',
      haldiDate: 'Tuesday, 21 April 2026', haldiTime: '10:00 AM',
      haldiVenueGroom: '14/78 Trilokpuri, Delhi-110091',
      haldiVenueBride: '1722/17 gali no. 22/1 D-block shukla colony Mukundpur, Delhi-110042',
      ...
      weddingDate: 'Tuesday, 21 April 2026 | 8:00 PM Onwards', weddingTime: '', weddingVenue: 'MARINA DREAMS BANQUET, Wazirpur Industrial Area, Ashok Vihar, Delhi - 110052',
      ...
      receptionDate: 'April 23, 2026', receptionTime: '7:00 PM onwards', receptionVenue: 'S.K Rajwada Banquet Hall, Club Ave Rd, Mayur Place, Mayur Vihar, Delhi, 110091',
    ...
    hi: {
      ...
      heroLocation: 'दिल्ली',
      heroExplore: 'देखें',
      countdownLabel: 'मंगलवार, 21 अप्रैल 2026 | 8:00 PM Onwards', countdownTitle: 'शुभ दिन',
      cdDays: 'दिन', cdHours: 'घंटे', cdMin: 'मिनट', cdSec: 'सेकंड',
      countdownNote: 'दास और हालदार परिवार आपको सादर आमंत्रित करते हैं',
      ...
      haldiTag: 'हल्दी की रस्म', haldiName: 'हल्दी समारोह',
    ...
    bn: {
      ...
      countdownNote: 'দাস ও হালদার পরিবার আপনাকে সাদর আমন্ত্রণ জানাচ্ছেন',
      ...
      haldiTag: 'হলুদ রঙের ছোঁয়া', haldiName: 'গায়ে হলুদ অনুষ্ঠান',
